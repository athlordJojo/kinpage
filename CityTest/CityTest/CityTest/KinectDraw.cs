...
namespace Kinampage
{
    public class KinectDraw
    {
        ...
        public void drawBody(Skeleton playerSkeleton, SpriteBatch sb)
        {
            ...
            if (isRightHandOpen)
            {
                drawBodyPartMiddle(sb, playerSkeleton.Joints[JointType.HandRight], playerSkeleton.Joints[JointType.ElbowRight], GraphicsUtil.hand, 0.5f, false, 0.81f);
            }
            else
            {
                drawBodyPartMiddle(sb, playerSkeleton.Joints[JointType.HandRight], playerSkeleton.Joints[JointType.ElbowRight], GraphicsUtil.fist, 0.5f, false, 0.81f);
            }

            if (isLeftHandOpen)
            {
                drawBodyPartMiddle(sb, playerSkeleton.Joints[JointType.HandLeft], playerSkeleton.Joints[JointType.ElbowLeft], GraphicsUtil.hand, 0.5f, true, 0.81f);
            }
            else
            {
                drawBodyPartMiddle(sb, playerSkeleton.Joints[JointType.HandLeft], playerSkeleton.Joints[JointType.ElbowLeft], GraphicsUtil.fist, 0.5f, true, 0.81f);
            }
            ...
            drawBodyPartMiddleFoot(sb, playerSkeleton.Joints[JointType.FootRight], playerSkeleton.Joints[JointType.HipRight], GraphicsUtil.foot, 0.5f, false, 0.82f);//0.42
            drawBodyPartMiddleFoot(sb, playerSkeleton.Joints[JointType.FootLeft], playerSkeleton.Joints[JointType.HipLeft], GraphicsUtil.foot, 0.5f, true, 0.82f);
            //draw Arms
            drawBodyPartMiddle(sb, playerSkeleton.Joints[JointType.ElbowRight], playerSkeleton.Joints[JointType.ShoulderRight], GraphicsUtil.arm, 0.5f, false, 0.83f);
            drawBodyPartMiddle(sb, playerSkeleton.Joints[JointType.ElbowLeft], playerSkeleton.Joints[JointType.ShoulderLeft], GraphicsUtil.arm, 0.5f, true, 0.83f);
